                ...
                <div className="grid gap-8 px-10 py-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-gradient-to-r from-blue-400 to-blue-600 p-4 rounded-lg shadow-lg">
                            <h3 className="text-xl text-n-2 font-bold flex items-center">
                                <FaUserMd className="mr-2" /> Total Patients
                            </h3>
                            <p className="text-3xl text-n-2 ">{totalPatients}</p>
                            <p className="text-green-200 text-n-2 ">{2600}% than Last Month</p>
                        </div>
                        <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 p-4 rounded-lg shadow-lg">
                            ...
                            <p className="text-3xl text-n-2 ">{totalAppointments}</p>
                            <p className="text-n-2">{1200}% Last Month</p>
                        </div>
                        <div className="bg-gradient-to-r from-pink-400 to-pink-600 p-4 rounded-lg shadow-lg">
                            ...
                            <p className="text-green-200 text-white">800% Last Month</p>
                        </div>
                        <div className="bg-gradient-to-r from-purple-400 to-purple-600 p-4 rounded-lg shadow-lg">
                            <h3 className="text-xl text-white font-bold flex items-center">
                                <FaDollarSign className="mr-2 text-white" /> Total Revenue
                            </h3>
                            <p className="text-3xl text-white">$547</p>
                            <p className="text-white">100% Last Month</p>
                        </div>
                    </div>
